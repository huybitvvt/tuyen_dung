        ...
        <div className="grid gap-0">
          <div className="relative overflow-hidden p-3.5">
            <div className="relative">
              <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-[#e5dfd2] bg-[#fbf8ef] px-2.5 py-1 text-[9px] font-bold uppercase tracking-[0.18em] text-[#4f6540]">
                <Sparkles className="size-3.5" />
                Training / LMS
              </div>
              <h1 className="max-w-3xl font-display text-[26px] font-bold leading-none tracking-tight text-[#1b1c19]">
                Đào tạo nội bộ
              </h1>
              <p className="mt-2 max-w-2xl text-xs font-semibold leading-5 text-[#444840]">
          ...
          <div className="border-t border-[#e5dfd2] bg-[#fbf8ef] p-2.5">
            <div className="grid h-full grid-cols-3 gap-2">
              {[
                ...
                <div key={metric.label} className="rounded-lg border border-[#e5dfd2] bg-[#fffdf7] p-2.5 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#4f6540]/25 hover:shadow-md">
                  <div className="mb-2 flex h-7 w-7 items-center justify-center rounded-md bg-[#f2ead9] text-[#4f6540]">
                    <metric.icon className="size-4" />
                  </div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-[#676b62]">{metric.label}</p>
                  <p className="mt-1 text-lg font-bold leading-none text-[#1b1c19]">{metric.value}</p>
                </div>
              ))}
            </div>
          </div>
              ...
              <div className="p-3">
                <div className="mb-2.5 flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    <h2 className="line-clamp-2 text-[13px] font-black leading-5 text-[#1b1c19]">{course.name}</h2>
                  </div>
                  <span className={cn('status-pill shrink-0 px-2 py-1 text-[9px]', statusClass)}>{course.status}</span>
                </div>

                <p className="line-clamp-2 min-h-9 text-xs font-semibold leading-[1.55] text-[#444840]">{course.description}</p>

                <div className="mt-3 grid grid-cols-3 gap-1.5">
                  <div className="rounded-md border border-[#e5dfd2] bg-[#fbf8ef] p-2">
                ...
                <div className="mt-4 flex items-center justify-between gap-2 border-t border-[#e5dfd2]/80 pt-3">
                  ...
                  {course.kpiLeadEligible && <span className="shrink-0 rounded border border-[#4f6540]/20 bg-[#edf4e4] px-2 py-1 text-[9px] font-black uppercase tracking-widest text-[#4f6540]">KPI lead</span>}
                </div>
              </div>
            </Link>
          );
